...
# quest 1 (Cool quest)
execute if score @s quest.holding matches 1.. if score @s quest.holding_id matches 1 if score @s quest_1.seen matches 1.. run function sp:system/quest/1/refund
...
## quest 2 (mfw bread)
execute if score @s quest.holding matches 1.. if score @s quest.holding_id matches 2 if score @s quest_2.seen matches 1.. run function sp:system/quest/2/refund
...
execute if score @s quest.holding matches 1.. if score @s quest.holding_id matches 3 if score @s quest_3.seen matches 1.. run function sp:system/quest/3/refund
...
execute if score @s quest.holding matches 1.. if score @s quest.holding_id matches 4 if score @s quest_4.seen matches 1.. run function sp:system/quest/4/refund
...
execute if score @s quest.holding matches 1.. if score @s quest.holding_id matches 5 if score @s quest_5.seen matches 1.. run function sp:system/quest/5/refund
