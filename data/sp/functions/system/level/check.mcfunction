...
execute unless score @s lvl.combat matches 1.. run scoreboard players set @s lvl.combat 1
...
execute unless score @s lvl.combat.progress matches 1.. run scoreboard players set @s lvl.combat.progress 0