...
execute unless score @s temp_store.player_in_house matches 1.. unless score @s temp_store.player_item_booster_eligible matches 0 unless score @s temp_store.player_item_booster_eligible matches 3 if score @s temp_store.player_item_booster_profession matches 0 unless score @s lvl.mine.booster matches 2.. run function sp:system/level/booster/mine/start
execute unless score @s temp_store.player_in_house matches 1.. unless score @s temp_store.player_item_booster_eligible matches 0 unless score @s temp_store.player_item_booster_eligible matches 3 if score @s temp_store.player_item_booster_profession matches 1 unless score @s lvl.fish.booster matches 2.. run function sp:system/level/booster/fish/start
execute unless score @s temp_store.player_in_house matches 1.. unless score @s temp_store.player_item_booster_eligible matches 0 unless score @s temp_store.player_item_booster_eligible matches 3 if score @s temp_store.player_item_booster_profession matches 2 unless score @s lvl.farm.booster matches 2.. run function sp:system/level/booster/farm/start
execute unless score @s temp_store.player_in_house matches 1.. unless score @s temp_store.player_item_booster_eligible matches 0 unless score @s temp_store.player_item_booster_eligible matches 3 if score @s temp_store.player_item_booster_profession matches 3 unless score @s lvl.wood.booster matches 2.. run function sp:system/level/booster/wood/start
execute unless score @s temp_store.player_in_house matches 1.. unless score @s temp_store.player_item_booster_eligible matches 0 unless score @s temp_store.player_item_booster_eligible matches 3 if score @s temp_store.player_item_booster_profession matches 4 unless score @s lvl.combat.booster matches 2.. run function sp:system/level/booster/combat/start

# display ineligible
## TODO: display time remaining here
execute unless score @s temp_store.player_in_house matches 1.. if score @s temp_store.player_item_booster_profession matches 0 if score @s lvl.mine.booster matches 2.. if score @s temp_store.player_item_booster_eligible matches 1 run title @s actionbar [{"text":"You already have a Mining XP booster active.","color":"#B8E45A"}]
execute unless score @s temp_store.player_in_house matches 1.. if score @s temp_store.player_item_booster_profession matches 1 if score @s lvl.fish.booster matches 2.. if score @s temp_store.player_item_booster_eligible matches 1 run title @s actionbar [{"text":"You already have a Fishing XP booster active.","color":"#B8E45A"}]
execute unless score @s temp_store.player_in_house matches 1.. if score @s temp_store.player_item_booster_profession matches 2 if score @s lvl.farm.booster matches 2.. if score @s temp_store.player_item_booster_eligible matches 1 run title @s actionbar [{"text":"You already have a Farming XP booster active.","color":"#B8E45A"}]
execute unless score @s temp_store.player_in_house matches 1.. if score @s temp_store.player_item_booster_profession matches 3 if score @s lvl.wood.booster matches 2.. if score @s temp_store.player_item_booster_eligible matches 1 run title @s actionbar [{"text":"You already have a Foraging XP booster active.","color":"#B8E45A"}]
execute unless score @s temp_store.player_in_house matches 1.. if score @s temp_store.player_item_booster_profession matches 4 if score @s lvl.combat.booster matches 2.. if score @s temp_store.player_item_booster_eligible matches 1 run title @s actionbar [{"text":"You already have a Combat XP booster active.","color":"#B8E45A"}]
## housing
