...
# announce
tellraw @s ["",{"text":"[","color":"dark_gray"},{"text":"♦","color":"#B8E45A"},{"text":"] ","color":"dark_gray"},{"text":"You have activated a x","color":"#B8E45A"},{"score":{"name":"@s","objective":"lvl.combat.booster"},"color":"#B8E45A"},{"text":" Combat XP booster!","color":"#B8E45A"}]
# extras
