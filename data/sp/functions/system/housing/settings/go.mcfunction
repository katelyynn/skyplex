...
# open to visitors
## enabled
execute if score @e[tag=housing.temporary_settings,limit=1] housing.config.open_to_visitors matches 1.. run tellraw @s ["",{"text":"Open to visitors \u0020 \u0020","hoverEvent":{"action":"show_text","contents":[{"text":"Allow anyone on the server to enter your house, they cannot place or destroy though."}]}},{"text":"[","color":"white"},{"text":"✔","color":"green","bold":true},{"text":"]","color":"white"},{"text":"  ","color":"dark_gray"},{"text":"X","color":"red","bold":true,"clickEvent":{"action":"run_command","value":"/trigger housing.config.open_to_visitors_option set 0"}},{"text":" ","color":"dark_gray"}]
## disabled
execute unless score @e[tag=housing.temporary_settings,limit=1] housing.config.open_to_visitors matches 1.. run tellraw @s ["",{"text":"Open to visitors \u0020 \u0020","hoverEvent":{"action":"show_text","contents":[{"text":"Allow anyone on the server to enter your house, they cannot place or destroy though."}]}},{"text":" ","color":"dark_gray"},{"text":"✔","color":"green","bold":true,"clickEvent":{"action":"run_command","value":"/trigger housing.config.open_to_visitors_option set 1"}},{"text":" ","color":"dark_gray"},{"text":" [","color":"white"},{"text":"X","color":"red","bold":true},{"text":"]","color":"white"}]
