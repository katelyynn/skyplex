...
execute if score @e[tag=housing.location,tag=housing.temporary_location,limit=1] housing.config.open_to_visitors matches 1.. as @a[tag=!housing.temporary_entry,tag=!housing.player_timeout,distance=..1.25] at @s run function sp:system/housing/enter/player
