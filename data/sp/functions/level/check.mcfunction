...
execute unless score @s lvl.farm >= 0 internal run scoreboard players set @s lvl.farm 0
...
execute unless score @s lvl.farm >= 0 internal run playsound minecraft:entity.player.levelup player @s
...
execute unless score @s lvl.farm.progress >= 0 internal run scoreboard players set @s lvl.farm.progress 0