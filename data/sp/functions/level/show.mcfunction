...
## mining
execute if score @s lvl.mine matches 0 store result score @s lvl.goal run scoreboard players get mine.0 lvl.goal
...
## fishing
execute if score @s lvl.fish matches 0 store result score @s lvl.goal run scoreboard players get fish.0 lvl.goal
